namespace BigGustave
{
    ...
    public class RawPngData
    {
        ...
        public int RowStep => rowOffset + bytesPerPixel * width;

        public int RowSize => bytesPerPixel * width;
        ...
        internal RawPngData(byte[] data, int bytesPerPixel, int width, InterlaceMethod interlaceMethod, Palette palette, ColorType colorType)
        {
            if (width < 0)
            {
