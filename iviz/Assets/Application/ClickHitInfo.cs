...
namespace Iviz.App
{
    public sealed class ClickHitInfo
    {
        ...
        public ClickHitInfo(in Vector2 cursorPosition) => ray = Settings.MainCamera.ScreenPointToRay(cursorPosition);

        public ClickHitInfo(in Ray ray) => this.ray = ray;
