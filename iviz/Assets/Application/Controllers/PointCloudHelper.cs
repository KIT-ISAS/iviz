...
namespace Iviz.Controllers
{
    ...
    {
        public static int? GeneratePointBuffer(ref float4[] pointBuffer, PointCloud2 msg, string intensityChannel,
            out bool rgbaHint)
        {
            int numPoints;
            ...
            return GeneratePointBuffer(pointBuffer, msg, xOffset, yOffset, zOffset, iOffset, iField.Datatype, rgbaHint);
        }
    ...
    public class PointCloudHelperException : Exception
    {
        PointCloudHelperException(string msg) : base(msg)
        {
        }

        [DoesNotReturn]
        public static void Throw(string msg) => throw new PointCloudHelperException(msg);
    }
}