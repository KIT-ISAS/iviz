...
namespace Iviz.App
{
    ...
    public sealed class ConnectionConfiguration : JsonToString
    {
        ...
        [DataMember] public List<string> LastMasterUris { get; set; } = new();
        ...
        [DataMember] public string BridgeUri { get; set; } = "";
        [DataMember] public List<string> LastBridgeUris { get; set; } = new();
    }
}