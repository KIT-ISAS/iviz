...
namespace Iviz.Displays
{
    public class RoundedPlaneDisplay : MeshMarkerHolderDisplay
    {
        ...
        static Mesh GetQuadMesh() => Resource.Displays.Square.Object.GetComponent<MeshMarkerDisplay>().Mesh;
        ...
        MeshMarkerDisplay[] CreateObjects()
        {
            ...
            objects[4].Transform.localRotation = Quaternions.Rotate90AroundY;
            objects[5].Transform.localRotation = Quaternions.Rotate180AroundY;
            objects[6].Transform.localRotation = Quaternions.Rotate270AroundY;
            return objects;
        }
