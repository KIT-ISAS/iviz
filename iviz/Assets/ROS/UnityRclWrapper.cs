...
namespace Iviz.Ros
{
    public sealed class UnityRclWrapper : RclWrapper
    {
        ...
        public override int CreateSubscriptionHandle(out IntPtr subscriptionHandle, IntPtr nodeHandle, string topic,
            string type,
        ...
        public override int TakeSerializedMessage(IntPtr subscriptionHandle, IntPtr serializedMessage, out IntPtr ptr,
            out int length, out Roslib2.Guid gid, out byte moreRemaining) =>
            Rcl.TakeSerializedMessage(subscriptionHandle, serializedMessage, out ptr, out length, out gid,
                out moreRemaining);

        public override int Take(IntPtr subscriptionHandle, IntPtr messageContextHandle, out Roslib2.Guid guid,
        ...
        public override int CreatePublisherHandle(out IntPtr publisherHandle, IntPtr nodeHandle, string topic,
            string type,
            in RmwQosProfile profile) =>
        ...
        public override int CreateClientHandle(out IntPtr serviceClientHandle, IntPtr nodeHandle, string service,
            string type,
            in RmwQosProfile profile) =>
        ...
        public override int TakeResponse(IntPtr clientHandle, IntPtr serializedMessageHandle,
        ...
        public override int CreateServiceHandle(out IntPtr serviceHandle, IntPtr nodeHandle, string service,
            string type,
            in RmwQosProfile profile) =>
        ...
        public override int TakeRequest(IntPtr serviceHandle, IntPtr serializedMessageHandle,
        ...
        static class Rcl
        {
            const string Library = Settings.IsAndroid 
                ? "iviz_ros2_rcl_android"
                : "__Internal";
            ...
            public static extern int TakeSerializedMessage(IntPtr subscriptionHandle, IntPtr serializedMessage,
                out IntPtr ptr, out int length, out Roslib2.Guid gid, out byte moreRemaining);

            [DllImport(Library, EntryPoint = "native_rcl_take")]
            public static extern int Take(IntPtr subscriptionHandle, IntPtr contextHandle, out Roslib2.Guid guid,
                out byte moreRemaining);
            ...
            public static extern int IsServiceServerAvailable(IntPtr clientHandle, IntPtr nodeHandle,
                out byte isAvailable);

            [DllImport(Library, EntryPoint = "native_rcl_send_request")]
            public static extern int SendRequest(IntPtr clientHandle, IntPtr serializedMessageHandle,
                out long sequenceId);
