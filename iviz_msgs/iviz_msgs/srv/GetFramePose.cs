...
namespace Iviz.Msgs.IvizMsgs
{
    ...
    {
        [DataMember (Name = "is_valid")] public bool[] IsValid { get; set; } // Whether the entry is valid
        [DataMember (Name = "poses")] public GeometryMsgs.Pose[] Poses { get; set; } // The absolute poses
