...
namespace Iviz.Msgs.MeshMsgs
{
    ...
    public sealed class TriangleIndices : IDeserializable<TriangleIndices>, IMessage
    {
        ...
        public ISerializable RosDeserialize(ref Buffer b) => new TriangleIndices(ref b);
        
        TriangleIndices IDeserializable<TriangleIndices>.RosDeserialize(ref Buffer b) => new TriangleIndices(ref b);
