...
{
    [Preserve, DataContract (Name = "mesh_msgs/TriangleIndices")]
    public sealed class TriangleIndices : IDeserializable<TriangleIndices>, IMessage
    {
        ...
        public TriangleIndices(ref Buffer b)
        {
        ...
        [Preserve] public const string RosDependenciesBase64 =
                "H4sIAAAAAAAAClNWcElNy8zLLMnMz1PIT1NIVCgpykzMS89JVS9WKEstKslMTi3m5SrNzCsxNoo2jgWL" +
                "pVbEZ+alQGR4uQBLQxFDQwAAAA==";
