...
namespace Iviz.Msgs.MoveitMsgs
{
    ...
    public sealed class DisplayTrajectory : IDeserializable<DisplayTrajectory>, IMessage
    {
        ...
        ISerializable ISerializable.RosDeserializeBase(ref ReadBuffer b) => new DisplayTrajectory(ref b);
        
        public DisplayTrajectory RosDeserialize(ref ReadBuffer b) => new DisplayTrajectory(ref b);
        ...
        public const string MessageType = "moveit_msgs/DisplayTrajectory";
    
        public string RosMessageType => MessageType;
    
        /// <summary> MD5 hash of a compact representation of the message. </summary>
        public const string Md5Sum = "c3c039261ab9e8a11457dac56b6316c8";
    
        public string RosMd5Sum => Md5Sum;
    
        /// <summary> Base64 of the GZip'd compression of the concatenated dependencies file. </summary>
        public string RosDependenciesBase64 =>
                "H4sIAAAAAAAAE+1bbW8bNxL+vr+CqD/YvipyL06Lnop8SGKncdDEbuy+BoFA7VLS1qululxZVg/332+e" +
