...
namespace Iviz.Msgs.MoveitMsgs
{
    ...
    public sealed class ExecuteTrajectoryActionResult : IDeserializable<ExecuteTrajectoryActionResult>, IActionResult<ExecuteTrajectoryResult>
    {
        ...
        ISerializable ISerializable.RosDeserializeBase(ref ReadBuffer b) => new ExecuteTrajectoryActionResult(ref b);
        
        public ExecuteTrajectoryActionResult RosDeserialize(ref ReadBuffer b) => new ExecuteTrajectoryActionResult(ref b);
        ...
        public const string MessageType = "moveit_msgs/ExecuteTrajectoryActionResult";
    
        public string RosMessageType => MessageType;
    
        /// <summary> MD5 hash of a compact representation of the message. </summary>
        public const string Md5Sum = "8aaeab5c1cdb613e6a2913ebcc104c0d";
