...
namespace Iviz.Msgs.MoveitMsgs
{
    ...
    public sealed class ExecuteTrajectoryGoal : IDeserializable<ExecuteTrajectoryGoal>, IGoal<ExecuteTrajectoryActionGoal>
    {
        ...
        ISerializable ISerializable.RosDeserializeBase(ref ReadBuffer b) => new ExecuteTrajectoryGoal(ref b);
        
        public ExecuteTrajectoryGoal RosDeserialize(ref ReadBuffer b) => new ExecuteTrajectoryGoal(ref b);
        ...
        public const string MessageType = "moveit_msgs/ExecuteTrajectoryGoal";
    
        public string RosMessageType => MessageType;
    
        /// <summary> MD5 hash of a compact representation of the message. </summary>
        public const string Md5Sum = "054c09e62210d7faad2f9fffdad07b57";
