...
namespace Iviz.Msgs.MoveitMsgs
{
    ...
    public sealed class MotionPlanDetailedResponse : IDeserializable<MotionPlanDetailedResponse>, IMessage
    {
        ...
        ISerializable ISerializable.RosDeserializeBase(ref ReadBuffer b) => new MotionPlanDetailedResponse(ref b);
        
        public MotionPlanDetailedResponse RosDeserialize(ref ReadBuffer b) => new MotionPlanDetailedResponse(ref b);
        ...
        public const string MessageType = "moveit_msgs/MotionPlanDetailedResponse";
    
        public string RosMessageType => MessageType;
    
        /// <summary> MD5 hash of a compact representation of the message. </summary>
        public const string Md5Sum = "7b84c374bb2e37bdc0eba664f7636a8f";
