...
namespace Iviz.Msgs.MoveitMsgs
{
    ...
    public sealed class MotionPlanRequest : IDeserializable<MotionPlanRequest>, IMessage
    {
        ...
        public MotionPlanRequest RosDeserialize(ref ReadBuffer b) => new MotionPlanRequest(ref b);
        ...
        public const string MessageType = "moveit_msgs/MotionPlanRequest";
    
        public string RosMessageType => MessageType;
    
        /// <summary> MD5 hash of a compact representation of the message. </summary>
        public const string Md5Sum = "c3bec13a525a6ae66e0fc57b768fdca6";
