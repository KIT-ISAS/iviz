...
namespace Iviz.Msgs.MoveitMsgs
{
		...
		IAction<MoveGroupActionGoal, MoveGroupActionFeedback, MoveGroupActionResult>
    {
        ...
        public MoveGroupAction(ref ReadBuffer b)
        {
        ...
        ISerializable ISerializable.RosDeserializeBase(ref ReadBuffer b) => new MoveGroupAction(ref b);
        
        public MoveGroupAction RosDeserialize(ref ReadBuffer b) => new MoveGroupAction(ref b);
        ...
        public const string MessageType = "moveit_msgs/MoveGroupAction";
    
        public string RosMessageType => MessageType;
    
        /// <summary> MD5 hash of a compact representation of the message. </summary>
        public const string Md5Sum = "be9c7984423000efe94194063f359cfc";
    
        public string RosMd5Sum => Md5Sum;
    
        /// <summary> Base64 of the GZip'd compression of the concatenated dependencies file. </summary>
        public string RosDependenciesBase64 =>
                "H4sIAAAAAAAAE+09a3PbyJHf+StQcdVJytK0/NjNrhKlSpZorzaWqEi091UuFEgMSUQgwMVDNPfq/vv1" +
