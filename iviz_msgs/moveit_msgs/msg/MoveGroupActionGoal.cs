...
namespace Iviz.Msgs.MoveitMsgs
{
    ...
    public sealed class MoveGroupActionGoal : IDeserializable<MoveGroupActionGoal>, IActionGoal<MoveGroupGoal>
    {
        ...
        public MoveGroupActionGoal(ref ReadBuffer b)
        {
        ...
        ISerializable ISerializable.RosDeserializeBase(ref ReadBuffer b) => new MoveGroupActionGoal(ref b);
        
        public MoveGroupActionGoal RosDeserialize(ref ReadBuffer b) => new MoveGroupActionGoal(ref b);
        ...
        public const string Md5Sum = "df11ac1a643d87b6e6a6fe5af1823709";
