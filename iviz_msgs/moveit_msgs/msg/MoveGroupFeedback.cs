...
namespace Iviz.Msgs.MoveitMsgs
{
    ...
    public sealed class MoveGroupFeedback : IDeserializable<MoveGroupFeedback>, IFeedback<MoveGroupActionFeedback>
    {
        ...
        internal MoveGroupFeedback(ref Buffer b)
        {
            State = b.DeserializeString();
        }
        
        public ISerializable RosDeserialize(ref Buffer b) => new MoveGroupFeedback(ref b);
        
        MoveGroupFeedback IDeserializable<MoveGroupFeedback>.RosDeserialize(ref Buffer b) => new MoveGroupFeedback(ref b);
