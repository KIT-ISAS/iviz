...
namespace Iviz.Msgs.MoveitMsgs
{
    ...
    public sealed class MoveGroupGoal : IDeserializable<MoveGroupGoal>, IGoal<MoveGroupActionGoal>
    {
        ...
        ISerializable ISerializable.RosDeserializeBase(ref ReadBuffer b) => new MoveGroupGoal(ref b);
        
        public MoveGroupGoal RosDeserialize(ref ReadBuffer b) => new MoveGroupGoal(ref b);
        ...
        public const string MessageType = "moveit_msgs/MoveGroupGoal";
    
        public string RosMessageType => MessageType;
    
        /// <summary> MD5 hash of a compact representation of the message. </summary>
        public const string Md5Sum = "a6de2db49c561a49babce1a8172e8906";
