...
namespace Iviz.Msgs.MoveitMsgs
{
    ...
    public sealed class MoveGroupSequenceActionGoal : IDeserializable<MoveGroupSequenceActionGoal>, IActionGoal<MoveGroupSequenceGoal>
    {
        ...
        public MoveGroupSequenceActionGoal(ref ReadBuffer b)
        {
        ...
        ISerializable ISerializable.RosDeserializeBase(ref ReadBuffer b) => new MoveGroupSequenceActionGoal(ref b);
        
        public MoveGroupSequenceActionGoal RosDeserialize(ref ReadBuffer b) => new MoveGroupSequenceActionGoal(ref b);
        ...
        public const string MessageType = "moveit_msgs/MoveGroupSequenceActionGoal";
    
        public string RosMessageType => MessageType;
    
        /// <summary> MD5 hash of a compact representation of the message. </summary>
        public const string Md5Sum = "33db6638fb44f932dc55788fa9d72325";
