...
{
    [Preserve, DataContract (Name = "moveit_msgs/MoveGroupSequenceFeedback")]
    public sealed class MoveGroupSequenceFeedback : IDeserializable<MoveGroupSequenceFeedback>, IFeedback<MoveGroupSequenceActionFeedback>
    {
        ...
        {
            return new MoveGroupSequenceFeedback(ref b);
        }
        
        MoveGroupSequenceFeedback IDeserializable<MoveGroupSequenceFeedback>.RosDeserialize(ref Buffer b)
        {
            return new MoveGroupSequenceFeedback(ref b);
        }
