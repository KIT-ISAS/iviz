...
namespace Iviz.Msgs.MoveitMsgs
{
		...
		IAction<PickupActionGoal, PickupActionFeedback, PickupActionResult>
    {
        ...
        ISerializable ISerializable.RosDeserializeBase(ref ReadBuffer b) => new PickupAction(ref b);
        
        public PickupAction RosDeserialize(ref ReadBuffer b) => new PickupAction(ref b);
        ...
        public const string MessageType = "moveit_msgs/PickupAction";
    
        public string RosMessageType => MessageType;
    
        /// <summary> MD5 hash of a compact representation of the message. </summary>
        public const string Md5Sum = "966c9238fcaad4ba8d20e116b676ccc1";
