...
namespace Iviz.Msgs.MoveitMsgs
{
    ...
    public sealed class PlaceActionGoal : IDeserializable<PlaceActionGoal>, IActionGoal<PlaceGoal>
    {
        ...
        public PlaceActionGoal(ref ReadBuffer b)
        {
        ...
        ISerializable ISerializable.RosDeserializeBase(ref ReadBuffer b) => new PlaceActionGoal(ref b);
        
        public PlaceActionGoal RosDeserialize(ref ReadBuffer b) => new PlaceActionGoal(ref b);
        ...
        public const string MessageType = "moveit_msgs/PlaceActionGoal";
    
        public string RosMessageType => MessageType;
    
        /// <summary> MD5 hash of a compact representation of the message. </summary>
        public const string Md5Sum = "facadaee390f685ed5e693ac12f5aa3d";
