...
namespace Iviz.Msgs.MoveitMsgs
{
    ...
    public sealed class PlaceActionResult : IDeserializable<PlaceActionResult>, IActionResult<PlaceResult>
    {
        ...
        ISerializable ISerializable.RosDeserializeBase(ref ReadBuffer b) => new PlaceActionResult(ref b);
        
        public PlaceActionResult RosDeserialize(ref ReadBuffer b) => new PlaceActionResult(ref b);
        ...
        public const string MessageType = "moveit_msgs/PlaceActionResult";
    
        public string RosMessageType => MessageType;
    
        /// <summary> MD5 hash of a compact representation of the message. </summary>
        public const string Md5Sum = "a93c9107fd23796469241f1d40422dfa";
