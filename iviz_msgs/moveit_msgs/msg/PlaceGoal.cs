...
namespace Iviz.Msgs.MoveitMsgs
{
    ...
    public sealed class PlaceGoal : IDeserializable<PlaceGoal>, IGoal<PlaceActionGoal>
    {
        ...
        ISerializable ISerializable.RosDeserializeBase(ref ReadBuffer b) => new PlaceGoal(ref b);
        
        public PlaceGoal RosDeserialize(ref ReadBuffer b) => new PlaceGoal(ref b);
        ...
        public const string Md5Sum = "e3f3e956e536ccd313fd8f23023f0a94";
