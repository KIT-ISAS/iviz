...
namespace Iviz.Msgs.MoveitMsgs
{
    ...
    public sealed class PlanningSceneComponents : IDeserializable<PlanningSceneComponents>, IMessage
    {
        ...
        public PlanningSceneComponents RosDeserialize(ref ReadBuffer b) => new PlanningSceneComponents(ref b);
        ...
        public const string MessageType = "moveit_msgs/PlanningSceneComponents";
    
        public string RosMessageType => MessageType;
    
        /// <summary> MD5 hash of a compact representation of the message. </summary>
        public const string Md5Sum = "bc993e784476960b918b6e7ad5bb58ce";
