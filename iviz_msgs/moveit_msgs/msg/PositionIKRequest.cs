...
namespace Iviz.Msgs.MoveitMsgs
{
    ...
    public sealed class PositionIKRequest : IDeserializable<PositionIKRequest>, IMessage
    {
        ...
        public PositionIKRequest RosDeserialize(ref ReadBuffer b) => new PositionIKRequest(ref b);
        ...
        public const string MessageType = "moveit_msgs/PositionIKRequest";
    
        public string RosMessageType => MessageType;
    
        /// <summary> MD5 hash of a compact representation of the message. </summary>
        public const string Md5Sum = "9936dc239c90af180ec94a51596c96f2";
