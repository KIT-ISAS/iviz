...
{
    [DataContract]
    public sealed class TestRequestActionFeedback : IDeserializableRos1<TestRequestActionFeedback>, IDeserializableRos2<TestRequestActionFeedback>, IMessageRos1, IMessageRos2, IActionFeedback<TestRequestFeedback>
    {
