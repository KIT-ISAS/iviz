...
{
    [DataContract]
    public sealed class TestRequestActionResult : IDeserializableRos1<TestRequestActionResult>, IMessageRos1, IActionResult<TestRequestResult>
    {
        ...
        ISerializable ISerializable.RosDeserializeBase(ref ReadBuffer b) => new TestRequestActionResult(ref b);
