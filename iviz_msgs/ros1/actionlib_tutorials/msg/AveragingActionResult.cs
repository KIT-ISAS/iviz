...
{
    [DataContract]
    public sealed class AveragingActionResult : IDeserializable<AveragingActionResult>, IHasSerializer<AveragingActionResult>, IMessage, IActionResult<AveragingResult>
    {
