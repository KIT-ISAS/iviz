...
namespace Iviz.Msgs.ActionlibTutorials
{
    ...
    public sealed class AveragingResult : IHasSerializer<AveragingResult>, IMessage, IResult<AveragingActionResult>
    {
        ...
        sealed class Serializer : Serializer<AveragingResult>
        {
            ...
            public override int RosMessageLength(AveragingResult _) => RosFixedMessageLength;
            public override int Ros2MessageLength(AveragingResult _) => Ros2FixedMessageLength;
        }
