...
{
    [DataContract]
    public sealed class FibonacciGoal : IHasSerializer<FibonacciGoal>, IMessage, IGoal<FibonacciActionGoal>
    {
        //goal definition
        ...
        sealed class Serializer : Serializer<FibonacciGoal>
        {
            ...
            public override int RosMessageLength(FibonacciGoal _) => RosFixedMessageLength;
            public override int Ros2MessageLength(FibonacciGoal _) => Ros2FixedMessageLength;
        }
