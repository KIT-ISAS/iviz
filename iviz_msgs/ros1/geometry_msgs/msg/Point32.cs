...
namespace Iviz.Msgs.GeometryMsgs
{
    ...
    public struct Point32 : IMessage, IHasSerializer<Point32>
    {
        ...
        [IgnoreDataMember] public readonly float SquaredNorm => Dot(this);
        [IgnoreDataMember] public readonly float Norm => (float)System.Math.Sqrt(SquaredNorm);
        [IgnoreDataMember] public readonly Point32 Normalized => this / Norm;
        ...
        sealed class Serializer : Serializer<Point32>
        {
            ...
            public override int RosMessageLength(Point32 _) => RosFixedMessageLength;
            public override int Ros2MessageLength(Point32 _) => Ros2FixedMessageLength;
        }
