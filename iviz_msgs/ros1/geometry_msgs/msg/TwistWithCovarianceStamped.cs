...
{
    [DataContract]
    public sealed class TwistWithCovarianceStamped : IDeserializableRos1<TwistWithCovarianceStamped>, IMessageRos1
    {
        ...
        ISerializable ISerializable.RosDeserializeBase(ref ReadBuffer b) => new TwistWithCovarianceStamped(ref b);
