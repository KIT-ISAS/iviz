...
{
    [DataContract]
    public sealed class ByteMultiArray : IDeserializableRos1<ByteMultiArray>, IMessageRos1
    {
        ...
        ISerializable ISerializable.RosDeserializeBase(ref ReadBuffer b) => new ByteMultiArray(ref b);
