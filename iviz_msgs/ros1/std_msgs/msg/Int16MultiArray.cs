...
{
    [DataContract]
    public sealed class Int16MultiArray : IHasSerializer<Int16MultiArray>, IMessage
    {
        ...
        public Int16MultiArray(ref ReadBuffer b)
        {
            Layout = new MultiArrayLayout(ref b);
            {
                ...
                if (n != 0)
                {
                    b.DeserializeStructArray(ref Unsafe.As<short, byte>(ref array[0]), n * 2);
                }
                Data = array;
            }
        }
        ...
        sealed class Serializer : Serializer<Int16MultiArray>
        {
            ...
            public override int Ros2MessageLength(Int16MultiArray msg) => msg.AddRos2MessageLength(0);
            public override void RosValidate(Int16MultiArray msg) => msg.RosValidate();
        }
