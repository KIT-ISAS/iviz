...
{
    [DataContract]
    public sealed class Int32MultiArray : IHasSerializer<Int32MultiArray>, IMessage
    {
        ...
        sealed class Serializer : Serializer<Int32MultiArray>
        {
            ...
            public override int Ros2MessageLength(Int32MultiArray msg) => msg.AddRos2MessageLength(0);
