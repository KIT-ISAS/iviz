...
{
    [DataContract]
    public sealed class Int32MultiArray : IDeserializableRos1<Int32MultiArray>, IDeserializableRos2<Int32MultiArray>, IMessageRos1, IMessageRos2
    {
        ...
        ISerializableRos1 ISerializableRos1.RosDeserializeBase(ref ReadBuffer b) => new Int32MultiArray(ref b);
