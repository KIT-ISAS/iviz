...
{
    [DataContract]
    public sealed class UInt16MultiArray : IHasSerializer<UInt16MultiArray>, IMessage
    {
        ...
        public UInt16MultiArray(ref ReadBuffer b)
        {
            Layout = new MultiArrayLayout(ref b);
            {
                ...
                if (n != 0)
                {
                    b.DeserializeStructArray(ref Unsafe.As<ushort, byte>(ref array[0]), n * 2);
                }
                Data = array;
            }
        }
        ...
        sealed class Serializer : Serializer<UInt16MultiArray>
        {
            ...
            public override int Ros2MessageLength(UInt16MultiArray msg) => msg.AddRos2MessageLength(0);
