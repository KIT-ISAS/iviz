...
{
    [DataContract]
    public sealed class UInt16MultiArray : IDeserializableRos1<UInt16MultiArray>, IMessageRos1
    {
        ...
        ISerializable ISerializable.RosDeserializeBase(ref ReadBuffer b) => new UInt16MultiArray(ref b);
