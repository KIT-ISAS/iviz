...
{
    [DataContract]
    public sealed class UInt32MultiArray : IDeserializableRos1<UInt32MultiArray>, IDeserializableRos2<UInt32MultiArray>, IMessageRos1, IMessageRos2
    {
        ...
        ISerializableRos1 ISerializableRos1.RosDeserializeBase(ref ReadBuffer b) => new UInt32MultiArray(ref b);
