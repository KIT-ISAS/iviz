...
{
    [DataContract]
    public sealed class UInt32MultiArray : IHasSerializer<UInt32MultiArray>, IMessage
    {
        ...
        sealed class Serializer : Serializer<UInt32MultiArray>
        {
            ...
            public override int Ros2MessageLength(UInt32MultiArray msg) => msg.AddRos2MessageLength(0);
            public override void RosValidate(UInt32MultiArray msg) => msg.RosValidate();
        }
