...
{
    [DataContract]
    public sealed class UInt8MultiArray : IDeserializableRos1<UInt8MultiArray>, IMessageRos1
    {
        ...
        ISerializable ISerializable.RosDeserializeBase(ref ReadBuffer b) => new UInt8MultiArray(ref b);
