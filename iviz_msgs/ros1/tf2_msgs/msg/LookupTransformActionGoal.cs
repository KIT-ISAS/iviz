...
{
    [DataContract]
    public sealed class LookupTransformActionGoal : IDeserializable<LookupTransformActionGoal>, IHasSerializer<LookupTransformActionGoal>, IMessage, IActionGoal<LookupTransformGoal>
    {
