...
namespace Iviz.Msgs.RclInterfaces
{
    ...
    public sealed class ListParametersRequest : IRequest<ListParameters, ListParametersResponse>, IDeserializable<ListParametersRequest>
    {
        ...
        ISerializableRos1 ISerializableRos1.RosDeserializeBase(ref ReadBuffer b) => new ListParametersRequest(ref b);
        ...
        public void AddRos2MessageLength(ref int c)
        {
            ...
            WriteBuffer2.AddLength(ref c, Depth);
        }
    ...
    public sealed class ListParametersResponse : IResponse, IDeserializable<ListParametersResponse>
    {
        ...
        ISerializableRos1 ISerializableRos1.RosDeserializeBase(ref ReadBuffer b) => new ListParametersResponse(ref b);
