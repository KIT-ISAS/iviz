...
namespace Iviz.Msgs.RclInterfaces
{
    ...
    public sealed class SetParametersRequest : IRequest<SetParameters, SetParametersResponse>, IDeserializable<SetParametersRequest>
    {
        ...
        ISerializableRos1 ISerializableRos1.RosDeserializeBase(ref ReadBuffer b) => new SetParametersRequest(ref b);
    ...
    public sealed class SetParametersResponse : IResponse, IDeserializable<SetParametersResponse>
    {
        ...
        ISerializableRos1 ISerializableRos1.RosDeserializeBase(ref ReadBuffer b) => new SetParametersResponse(ref b);
        ...
        public void AddRos2MessageLength(ref int c)
        {
            WriteBuffer2.AddLength(ref c, Results);
        }
