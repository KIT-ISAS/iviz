...
{
    public class ServiceResponseDetails : IService
    {
        ...
        public const string _ServiceType = "rosapi/ServiceResponseDetails";
        ...
        public ServiceResponseDetails(Request request)
        {
