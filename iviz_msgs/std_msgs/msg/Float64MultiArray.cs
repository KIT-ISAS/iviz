...
namespace Iviz.Msgs.std_msgs
{
    public sealed class Float64MultiArray : IMessage
    {
        ...
        public double[] data { get; set; } // array of data
        ...
        internal Float64MultiArray(Buffer b)
        {
            ...
            this.data = BuiltIns.DeserializeStructArray<double>(b, 0);
        }
        
        public IMessage Deserialize(Buffer b)
        {
            if (b is null) throw new System.ArgumentNullException(nameof(b));
            return new Float64MultiArray(b);
        }
        ...
        [Preserve]
        public const string RosMd5Sum = "4b7d974086d4060e7db4613a7e6c3ba4";
