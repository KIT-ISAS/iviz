...
namespace Iviz.Msgs.std_msgs
{
    public sealed class Int16MultiArray : IMessage
    {
        ...
        public short[] data { get; set; } // array of data
        ...
        internal Int16MultiArray(Buffer b)
        {
            ...
            this.data = BuiltIns.DeserializeStructArray<short>(b, 0);
        }
        
        public IMessage Deserialize(Buffer b)
        {
            if (b is null) throw new System.ArgumentNullException(nameof(b));
            return new Int16MultiArray(b);
        }
        ...
        [Preserve]
        public const string RosMd5Sum = "d9338d7f523fcb692fae9d0a0e9f067c";
