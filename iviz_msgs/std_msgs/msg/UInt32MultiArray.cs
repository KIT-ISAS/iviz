...
namespace Iviz.Msgs.std_msgs
{
    ...
    public sealed class UInt32MultiArray : IMessage
    {
        ...
        [DataMember] public uint[] data { get; set; } // array of data
        ...
        internal UInt32MultiArray(Buffer b)
        {
            ...
            this.data = b.DeserializeStructArray<uint>();
        }
        
        ISerializable ISerializable.Deserialize(Buffer b)
        {
            return new UInt32MultiArray(b ?? throw new System.ArgumentNullException(nameof(b)));
        }
