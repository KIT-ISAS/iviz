...
#ifndef IVIZ_MSGS__SRV__DETAIL__CAPTURE_SCREENSHOT__FUNCTIONS_H_
#define IVIZ_MSGS__SRV__DETAIL__CAPTURE_SCREENSHOT__FUNCTIONS_H_
...
#include "iviz_msgs/srv/detail/capture_screenshot__struct.h"

/// Initialize srv/CaptureScreenshot message.
/**
...
/// Finalize srv/CaptureScreenshot message.
/**
...
/// Create srv/CaptureScreenshot message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * iviz_msgs__srv__CaptureScreenshot_Request__init().
...
/// Destroy srv/CaptureScreenshot message.
/**
 * It calls
 * iviz_msgs__srv__CaptureScreenshot_Request__fini()
...
/// Check for srv/CaptureScreenshot message equality.
/**
...
/// Copy a srv/CaptureScreenshot message.
/**
...
/// Initialize array of srv/CaptureScreenshot messages.
/**
...
/// Finalize array of srv/CaptureScreenshot messages.
/**
 * It calls
 * iviz_msgs__srv__CaptureScreenshot_Request__fini()
...
/// Create array of srv/CaptureScreenshot messages.
/**
 * It allocates the memory for the array and calls
 * iviz_msgs__srv__CaptureScreenshot_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/CaptureScreenshot messages.
/**
 * It calls
 * iviz_msgs__srv__CaptureScreenshot_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/CaptureScreenshot message array equality.
/**
...
/// Copy an array of srv/CaptureScreenshot messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * iviz_msgs__srv__CaptureScreenshot_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_iviz_msgs
...
/**
 * It calls
 * iviz_msgs__srv__CaptureScreenshot_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_iviz_msgs
...
/**
 * It allocates the memory for the array and calls
 * iviz_msgs__srv__CaptureScreenshot_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_iviz_msgs
...
/**
 * It calls
 * iviz_msgs__srv__CaptureScreenshot_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // IVIZ_MSGS__SRV__DETAIL__CAPTURE_SCREENSHOT__FUNCTIONS_H_
