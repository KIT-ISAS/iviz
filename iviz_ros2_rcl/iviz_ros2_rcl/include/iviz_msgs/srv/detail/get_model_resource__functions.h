...
#ifndef IVIZ_MSGS__SRV__DETAIL__GET_MODEL_RESOURCE__FUNCTIONS_H_
#define IVIZ_MSGS__SRV__DETAIL__GET_MODEL_RESOURCE__FUNCTIONS_H_
...
#include "iviz_msgs/srv/detail/get_model_resource__struct.h"

/// Initialize srv/GetModelResource message.
/**
...
/// Finalize srv/GetModelResource message.
/**
...
/// Create srv/GetModelResource message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * iviz_msgs__srv__GetModelResource_Request__init().
...
/// Destroy srv/GetModelResource message.
/**
 * It calls
 * iviz_msgs__srv__GetModelResource_Request__fini()
...
/// Check for srv/GetModelResource message equality.
/**
...
/// Copy a srv/GetModelResource message.
/**
...
/// Initialize array of srv/GetModelResource messages.
/**
...
/// Finalize array of srv/GetModelResource messages.
/**
 * It calls
 * iviz_msgs__srv__GetModelResource_Request__fini()
...
/// Create array of srv/GetModelResource messages.
/**
 * It allocates the memory for the array and calls
 * iviz_msgs__srv__GetModelResource_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetModelResource messages.
/**
 * It calls
 * iviz_msgs__srv__GetModelResource_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetModelResource message array equality.
/**
...
/// Copy an array of srv/GetModelResource messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * iviz_msgs__srv__GetModelResource_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_iviz_msgs
...
/**
 * It calls
 * iviz_msgs__srv__GetModelResource_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_iviz_msgs
...
/**
 * It allocates the memory for the array and calls
 * iviz_msgs__srv__GetModelResource_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_iviz_msgs
...
/**
 * It calls
 * iviz_msgs__srv__GetModelResource_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // IVIZ_MSGS__SRV__DETAIL__GET_MODEL_RESOURCE__FUNCTIONS_H_
