...
#include "iviz_msgs/srv/detail/update_module__functions.h"
...
iviz_msgs__srv__UpdateModule_Request__init(iviz_msgs__srv__UpdateModule_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->id)) {
    iviz_msgs__srv__UpdateModule_Request__fini(msg);
    return false;
  }
  // fields
  if (!rosidl_runtime_c__String__Sequence__init(&msg->fields, 0)) {
    iviz_msgs__srv__UpdateModule_Request__fini(msg);
    return false;
  }
  // config
...
iviz_msgs__srv__UpdateModule_Request__fini(iviz_msgs__srv__UpdateModule_Request * msg)
{
  ...
  // fields
  rosidl_runtime_c__String__Sequence__fini(&msg->fields);
  // config
...
{
  iviz_msgs__srv__UpdateModule_Request * msg = (iviz_msgs__srv__UpdateModule_Request *)malloc(sizeof(iviz_msgs__srv__UpdateModule_Request));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(iviz_msgs__srv__UpdateModule_Request));
  bool success = iviz_msgs__srv__UpdateModule_Request__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
iviz_msgs__srv__UpdateModule_Request__Sequence__init(iviz_msgs__srv__UpdateModule_Request__Sequence * array, size_t size)
{
  ...
  iviz_msgs__srv__UpdateModule_Request * data = NULL;
  if (size) {
    data = (iviz_msgs__srv__UpdateModule_Request *)calloc(size, sizeof(iviz_msgs__srv__UpdateModule_Request));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = iviz_msgs__srv__UpdateModule_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        iviz_msgs__srv__UpdateModule_Request__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
iviz_msgs__srv__UpdateModule_Request__Sequence__fini(iviz_msgs__srv__UpdateModule_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      iviz_msgs__srv__UpdateModule_Request__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  iviz_msgs__srv__UpdateModule_Request__Sequence * array = (iviz_msgs__srv__UpdateModule_Request__Sequence *)malloc(sizeof(iviz_msgs__srv__UpdateModule_Request__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = iviz_msgs__srv__UpdateModule_Request__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    iviz_msgs__srv__UpdateModule_Request__Sequence__fini(array);
  }
  free(array);
}
...
iviz_msgs__srv__UpdateModule_Request__Sequence__are_equal(const iviz_msgs__srv__UpdateModule_Request__Sequence * lhs, const iviz_msgs__srv__UpdateModule_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!iviz_msgs__srv__UpdateModule_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  iviz_msgs__srv__UpdateModule_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(iviz_msgs__srv__UpdateModule_Request);
    iviz_msgs__srv__UpdateModule_Request * data =
      (iviz_msgs__srv__UpdateModule_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!iviz_msgs__srv__UpdateModule_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          iviz_msgs__srv__UpdateModule_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!iviz_msgs__srv__UpdateModule_Request__copy(
...
iviz_msgs__srv__UpdateModule_Response__init(iviz_msgs__srv__UpdateModule_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    iviz_msgs__srv__UpdateModule_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  iviz_msgs__srv__UpdateModule_Response * msg = (iviz_msgs__srv__UpdateModule_Response *)malloc(sizeof(iviz_msgs__srv__UpdateModule_Response));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(iviz_msgs__srv__UpdateModule_Response));
  bool success = iviz_msgs__srv__UpdateModule_Response__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
iviz_msgs__srv__UpdateModule_Response__Sequence__init(iviz_msgs__srv__UpdateModule_Response__Sequence * array, size_t size)
{
  ...
  iviz_msgs__srv__UpdateModule_Response * data = NULL;
  if (size) {
    data = (iviz_msgs__srv__UpdateModule_Response *)calloc(size, sizeof(iviz_msgs__srv__UpdateModule_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = iviz_msgs__srv__UpdateModule_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        iviz_msgs__srv__UpdateModule_Response__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
iviz_msgs__srv__UpdateModule_Response__Sequence__fini(iviz_msgs__srv__UpdateModule_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      iviz_msgs__srv__UpdateModule_Response__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  iviz_msgs__srv__UpdateModule_Response__Sequence * array = (iviz_msgs__srv__UpdateModule_Response__Sequence *)malloc(sizeof(iviz_msgs__srv__UpdateModule_Response__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = iviz_msgs__srv__UpdateModule_Response__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    iviz_msgs__srv__UpdateModule_Response__Sequence__fini(array);
  }
  free(array);
}
...
iviz_msgs__srv__UpdateModule_Response__Sequence__are_equal(const iviz_msgs__srv__UpdateModule_Response__Sequence * lhs, const iviz_msgs__srv__UpdateModule_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!iviz_msgs__srv__UpdateModule_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  iviz_msgs__srv__UpdateModule_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(iviz_msgs__srv__UpdateModule_Response);
    iviz_msgs__srv__UpdateModule_Response * data =
      (iviz_msgs__srv__UpdateModule_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!iviz_msgs__srv__UpdateModule_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          iviz_msgs__srv__UpdateModule_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!iviz_msgs__srv__UpdateModule_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
