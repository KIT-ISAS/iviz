...
struct MetricsMessage_
{
  ...
  using _statistics_type =
    std::vector<statistics_msgs::msg::StatisticDataPoint_<ContainerAllocator>, typename ContainerAllocator::template rebind<statistics_msgs::msg::StatisticDataPoint_<ContainerAllocator>>::other>;
  ...
  Type & set__statistics(
    const std::vector<statistics_msgs::msg::StatisticDataPoint_<ContainerAllocator>, typename ContainerAllocator::template rebind<statistics_msgs::msg::StatisticDataPoint_<ContainerAllocator>>::other> & _arg)
  {
