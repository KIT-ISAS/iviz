...
struct BoundedSequences_
{
  ...
  using _basic_types_values_type =
    rosidl_runtime_cpp::BoundedVector<test_msgs::msg::BasicTypes_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<test_msgs::msg::BasicTypes_<ContainerAllocator>>::other>;
  _basic_types_values_type basic_types_values;
  using _constants_values_type =
    rosidl_runtime_cpp::BoundedVector<test_msgs::msg::Constants_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<test_msgs::msg::Constants_<ContainerAllocator>>::other>;
  _constants_values_type constants_values;
  using _defaults_values_type =
    rosidl_runtime_cpp::BoundedVector<test_msgs::msg::Defaults_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<test_msgs::msg::Defaults_<ContainerAllocator>>::other>;
  ...
  Type & set__basic_types_values(
    const rosidl_runtime_cpp::BoundedVector<test_msgs::msg::BasicTypes_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<test_msgs::msg::BasicTypes_<ContainerAllocator>>::other> & _arg)
  {
    this->basic_types_values = _arg;
    return *this;
  }
  Type & set__constants_values(
    const rosidl_runtime_cpp::BoundedVector<test_msgs::msg::Constants_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<test_msgs::msg::Constants_<ContainerAllocator>>::other> & _arg)
  {
    this->constants_values = _arg;
    return *this;
  }
  Type & set__defaults_values(
    const rosidl_runtime_cpp::BoundedVector<test_msgs::msg::Defaults_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<test_msgs::msg::Defaults_<ContainerAllocator>>::other> & _arg)
  {
