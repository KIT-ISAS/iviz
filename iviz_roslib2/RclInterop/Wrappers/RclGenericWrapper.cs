...
public sealed class RclGenericWrapper : RclWrapper
{
    ...
    public override int Take(IntPtr subscriptionHandle, IntPtr messageContextHandle, out Guid guid,
    ...
    static class Rcl
    {
        const string Library = "iviz_ros2_rcl";
        ...
        public static extern int Take(IntPtr subscriptionHandle, IntPtr messageContextHandle, out Guid guid,
            out byte moreRemaining);
